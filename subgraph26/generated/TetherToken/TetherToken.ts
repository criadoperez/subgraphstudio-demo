...
export class _giveMeATokensCall extends ethereum.Call {
  get inputs(): _giveMeATokensCall__Inputs {
    return new _giveMeATokensCall__Inputs(this);
  }

  get outputs(): _giveMeATokensCall__Outputs {
    return new _giveMeATokensCall__Outputs(this);
  }
}

export class _giveMeATokensCall__Inputs {
  _call: _giveMeATokensCall;

  constructor(call: _giveMeATokensCall) {
    this._call = call;
  }
...
export class _giveMeATokensCall__Outputs {
  _call: _giveMeATokensCall;
